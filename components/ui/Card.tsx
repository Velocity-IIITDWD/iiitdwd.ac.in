...
export default function Card({
    ...
    return (
        <div className="flex-shrink-0 mx-2 mb-4 rounded-lg overflow-hidden shadow-md border border-gray-200 hover:bg-customBlue hover:text-white transition-colors duration-300">
