...
const MainCarousel: React.FC<PropType> = ({ options, children }) => {
  ...
  return (
    <section className="relative">
      ...
      <button
        className="absolute top-1/2 -translate-y-1/2 cursor-pointer p-1 rounded left-2"
      ...
      <button
        className="absolute top-1/2 -translate-y-1/2 cursor-pointer p-1 rounded right-2"
