      ...
      <div className="w-fit max-w-5xl p-4 flex flex-col gap-4 pb-12">
        ...
        <div className="flex gap-4 max-lg:flex-wrap justify-center mb-4">
          ...
          <div className="shrink">
            <p className="font-bold text-lg text-dwd-primary">About Kaleidoscope</p>
            <p>{about.description}</p>
          </div>
        </div>
        <p className='text-center font-bold text-dwd-primary text-2xl' id="issues">Issues</p>
        <Issues />
        <p className='text-center font-bold text-dwd-primary text-2xl mt-4'>Magazine Team</p>
        ...
        </div>
        {
          teams.map(team => (
            <Fragment key={team.teamId}>
              <p className='text-lg font-bold mt-2 text-dwd-primary'>{team.teamName}</p>
