...
import { CopyrightIcon, FacebookIcon, HomeIcon, LinkedinIcon, MailIcon, PhoneIcon, YoutubeIcon } from 'lucide-react';
...
function Footer() {
    return (
        <footer className='flex flex-col bg-dwd-primary text-white text-xs w-full h-fit px-8 py-4 gap-8'>
