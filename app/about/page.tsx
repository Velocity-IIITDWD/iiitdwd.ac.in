  ...
  return (
    <div className="w-full h-screen overflow-auto flex flex-col items-center">
      ...
      <div className="w-full p-8 flex flex-col items-center bg-dwd-secondary2">
        <span className="font-bold mb-4 text-3xl md:text-4xl bg-dwd-secondary2 text-dwd-primary">
          About IIIT Dharwad
        </span>
        <p className="md:text-lg">{aboutData.aboutText}</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-8 items-center">
        ...
        <Link
          className="bg-dwd-primary p-4 text-white text-center rounded-full text-lg md:text-xl"
          href={"/visitors"}
        >
          Visitor
        </Link>
      ...
      <div className="bg-dwd-secondary2 grid grid-cols-1 md:grid-cols-2 min-h-52 w-full items-center text-center">
        ...
        <p className="md:text-xl self-start md:self-center">{about.vision}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 p-8 gap-4 items-center min-h-52 bg-dwd-secondary2 w-full">
