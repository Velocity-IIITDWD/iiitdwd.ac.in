...
export default function Button(report: issueStructure) {
  return (
    <Link target='_blank' href={report.issueUrl} className='border-2 bg-dwd-secondary2/25 border-dwd-secondary2 p-2 gap-2 w-40 flex flex-col justify-center rounded'>
