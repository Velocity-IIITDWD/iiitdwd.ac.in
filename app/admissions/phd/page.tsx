    ...
    <div className="flex flex-col w-full md:w-11/12 bg-slate-200  rounded-md py-5 px-6 md:py-8 md:pl-9 md:pr-4">
        ...
        <div>
          ...
          <p>
            ...
            <br />
            1. Regular (Full-time) - Institute fellowship or self-financed or Visvesvaraya PhD Scheme
            <br />
            2. Sponsored (Full-time or Part-time)
            <br />
            3. Part-time
          ...
          <p>
            ...
            <br />
            2. B.E. / B.Tech. / M.Sc. / Technology or an equivalent degree, in relevant areas*
<br />
            3. B.E. / B.Tech. applicants with experience in a reputed R&D organization or a company, or those who have published papers in reputed conferences and journals, or patents are preferred.
          </p>
