        ...
        <div className="flex flex-col w-full md:w-11/12 bg-slate-200 rounded-md py-5 px-6 md:py-8 md:pl-9 md:pr-4">
          ...
          <div className="mt-2 mb-8 bg-white p-6 rounded-md shadow-md">
            ...
            <p className="mt-4">
              ...
              institute accepts applications on a rolling basis, under the
            ...
            <p className="mt-4">
              ...
              <Link
                href="/docs/M.Tech(R)-Admission-Rolling-Advertisement.pdf"
          ...
          <div>
            ...
            <div className="mt-4">
              The minimum requirement is a B.E. / B.Tech. / M.Sc. / M.C.A. or
              equivalent for IT/Engineering disciplines with a valid score in an
              entrance examination such as GATE/NET or national level selection
              process conducted by IIIT Dharwad or any other national level
              examination.
            </div>
            <div className="font-bold mt-4 text-lg text-dwd-primary">
              <p className="text-[#db4444] text-lg">
                The minimum eligibility criteria for the M. Tech. program are
                given below:
              </p>
            ...
            <div className="my-4">
              ...
              and Communication Engineering but not limited to: Blockchain,
