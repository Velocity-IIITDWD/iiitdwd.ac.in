  ...
  return <div className="flex flex-col h-full w-full">
    ...
    <div className="flex justify-center md:my-10 ">
      <div className="flex flex-col w-full md:w-11/12 bg-slate-200  rounded-md py-5 px-6 md:py-8 md:pl-9 md:pr-4">
        <div>
          <div className="text-dwd-primary text-lg md:text-xl font-bold ">IIIT Dharwad offers M. Tech. (Research) program in Computer Science & Engineering, Data Science &   Intelligent Systems and Electronics & Communication Engineering in the following categories:
          </div>
          <ol>
            <li className="p-4">
