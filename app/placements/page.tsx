...
import CompaniesVisited from '@/assets/placements/Companies Visited.png'; 
import PlacementProcedure from '@/assets/placements/Placement Procedure.png'; 
...
export default function Home() {
  ...
  Overview
        ...
        <Image src={CompaniesVisited} width="800" height="150" className="mx-auto block mt-10" alt='Companies visited'/>
      
        <div className="shortbox text-[1.8rem] text-[#013365] font-extrabold ml-[20%] mt-20">Placement Procedure</div>
        <Image src={PlacementProcedure} width="800" height="150" className="mx-auto block mt-10 procedure" alt='Placement Procedure'/>
        ...
        <div className='mt-6 ml-[20%]'>
          <Link href="/brochure_cgc.pdf" target='_blank' className="text-[#013365] text-lg font-bold after:-translate-y-1/3 after:absolute relative after:content-[url('/icons/linkIcon.svg')]">
            Brochure
          </Link>
        </div>
